...
<body>
    ...
    <div>
        <ul id="navi-bar">
            ...
            <li><a class="nav-item" href="http://localhost/all/Service.php">Appointment</a></li>
        ...
        <div style="display: inline-block; padding-left: 30px;">
            <table>
                ...
                <?php
                    ...
                    $sql = "SELECT id, first_name, last_name, email, country, contact, username, password FROM counsellers";
